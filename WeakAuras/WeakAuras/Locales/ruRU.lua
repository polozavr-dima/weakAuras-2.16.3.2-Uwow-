...
L["/wa versioncheck - Check WeakAuras versions in your group"] = "/wa versioncheck - Проверить версии WeakAuras в группе"
L["WeakAuras version check: %s"] = "Проверка версии WeakAuras: %s"
L["No party or raid members found for WeakAuras version check."] = "Для проверки версии WeakAuras не найдены участники группы или рейда."
L["WeakAuras version check started. Waiting 5 seconds for replies..."] = "Проверка версии WeakAuras запущена. Жду ответы 5 секунд..."
L["WeakAuras version check finished: %d same, %d different, %d no reply."] = "Проверка версии WeakAuras завершена: %d совпадает, %d отличается, %d без ответа."
L["No reply"] = "Нет ответа"
L["different"] = "отличается"
L["same"] = "совпадает"
