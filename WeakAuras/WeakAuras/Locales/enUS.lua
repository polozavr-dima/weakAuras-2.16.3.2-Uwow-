...
L["/wa versioncheck - Check WeakAuras versions in your group"] = "/wa versioncheck - Check WeakAuras versions in your group"
L["WeakAuras version check: %s"] = "WeakAuras version check: %s"
L["No party or raid members found for WeakAuras version check."] = "No party or raid members found for WeakAuras version check."
L["WeakAuras version check started. Waiting 5 seconds for replies..."] = "WeakAuras version check started. Waiting 5 seconds for replies..."
L["WeakAuras version check finished: %d same, %d different, %d no reply."] = "WeakAuras version check finished: %d same, %d different, %d no reply."
L["No reply"] = "No reply"
